...
SELECT SUM(purchase) AS total_sales FROM walmart_sales;

-- Qual o ticket médio de compras?
SELECT AVG(purchase) AS avg_ticket FROM walmart_sales;
...
SELECT age, SUM(purchase) AS total_spent
FROM walmart_sales
GROUP BY age
ORDER BY total_spent DESC;

-- Categorias de produtos mais vendidas
SELECT product_category, COUNT(*) AS num_sales, SUM(purchase) AS revenue
FROM walmart_sales
